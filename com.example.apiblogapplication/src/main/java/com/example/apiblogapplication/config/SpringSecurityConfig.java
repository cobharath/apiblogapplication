package com.example.apiblogapplication.config;
...
import com.example.apiblogapplication.security.AuthenticationEntryPoint;
import com.example.apiblogapplication.security.CustumUserDetailsService;
import com.example.apiblogapplication.security.JWTAuthenticationFilter;
...
public class SpringSecurityConfig extends WebSecurityConfigurerAdapter   {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.csrf().disable().authorizeHttpRequests().antMatchers("/user/login").permitAll()
